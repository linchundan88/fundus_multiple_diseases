...
# TRAIN_TYPE = 'Subclass_1'
#
# from LIBS.ImgPreprocess.my_preprocess_dir import do_process_dir
# dir_original = '/media/ubuntu/data1/子类/1/original'
# dir_preprocess = '/media/ubuntu/data1/子类/1/preprocess384'

TRAIN_TYPE = 'Subclass_1_test_dataset'

from LIBS.ImgPreprocess.my_preprocess_dir import do_process_dir
dir_original = '/media/ubuntu/data1/子类/1/测试集_已标注/original'
dir_preprocess = '/media/ubuntu/data1/子类/1/测试集_已标注/preprocess384'
