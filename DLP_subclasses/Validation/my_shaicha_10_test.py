...
dir_original = '/media/ubuntu/data1/测试集分子类/original/10'
dir_preprocess512 = '/media/ubuntu/data1/测试集分子类/preprocess512/10'
dir_crop_optic_disc = '/media/ubuntu/data1/测试集分子类/Crop_optic_disc_112/10'
DIR_DEST_BASE = '/media/ubuntu/data1/测试集分子类/results/10'
