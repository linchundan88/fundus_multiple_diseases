...
from keras.layers import Input, merge ,Activation, BatchNormalization, Conv2D, MaxPooling2D, UpSampling2D, Conv2DTranspose, \
    Dropout, Cropping2D
...
def _residual_block(blockInput, num_filters=16):
...
# Build model
def get_unet_resnet_v1(input_shape, init_filters=16, dropout_ratio=0.2):
