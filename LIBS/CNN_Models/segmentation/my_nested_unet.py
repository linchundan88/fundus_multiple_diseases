...
def standard_unit(input_tensor, stage, nb_filter, kernel_size=3):
    ...
    if g_dropout_rate > 0:
        x = Dropout(g_dropout_rate, name='dp' + stage + '_1')(x)
    ...
    if g_BN:
        x = BatchNormalization()(x)
    if g_dropout_rate > 0:
        x = Dropout(g_dropout_rate, name='dp' + stage + '_2')(x)
...
def get_Nest_Unet(input_shape, num_class=1,
