"""A vanilla ThreeD resnet implementation.
...
https://github.com/JihongJu/keras-resnet3d/blob/master/train.py
...
def _shortcut3d(input, residual):
    """ThreeD shortcut to match input and residual and merges them with "sum"."""
...
class Resnet3DBuilder(object):
    ...
    def build(input_shape, num_outputs, block_fn, repetitions, reg_factor):
        ...
        # Returns
            model: a ThreeD ResNet model that takes a 5D tensor (volumetric images
