...
from LIBS.CNN_Models import squeeze_excite_block
...
def SE_InceptionResNetV2(input_shape=None,
                         include_top=True,
                         classes=1000,
                         weights=None,
                         input_tensor=None,
    ...
    backends (but not CNTK). The data1 format convention used by the model is
    ...
    # Arguments
        ...
        input_shape: optional shape tuple, only to be specified
            ...
            has to be `(299, 299, 3)` (with `'channels_last'` data1 format)
            or `(3, 299, 299)` (with `'channels_first'` data1 format).
