...
# from keras.LIBS import conv_utils
# from keras.LIBS.data_utils import get_file
    ...
    """Preprocesses a tensor encoding a batch of images.
       Obtained from https://github.com/cypw/DPNs
        # Arguments
            ...
            data_format: data1 format of the image tensor.
        # Returns
            Preprocessed tensor.
        """
...
if __name__ == '__main__':
    ...
    model = DPN92(input_shape=(224, 224, 3), classes=3)
    model.summary()