...
dict_lr_finetuning['0'] = 1e-3  # 0.001
dict_lr_finetuning['1'] = 3e-4  # 0.0003
dict_lr_finetuning['2'] = 1e-4  # 0.0001
dict_lr_finetuning['3'] = 3e-5  # 0.00003
dict_lr_finetuning['4'] = 1e-5  # 0.00001
dict_lr_finetuning['5'] = 3e-6  # 0.000003
...
MODEL_SAVE_DIR = '/media/ubuntu/data1/tmp5/2020_3_13_multabels'

PRE_TRAIN_TYPE = 'Fundus'
...
# for model_name in ['InceptionV3']:
    ...
    if model_name == 'Xception':
        if PRE_TRAIN_TYPE == 'ImageNet':
            model1 = keras.applications.inception_v3.InceptionV3(input_shape=None, include_top=True, weights='imagenet',
                                                                classes=1000)
        if PRE_TRAIN_TYPE == 'Fundus':
            model1 = '/home/ubuntu/dlp/deploy_models_2019/bigclass_multiclass/Transfer_learning/Xception-007-0.954.hdf5'

        train_task(filename_csv_train=filename_csv_train, filename_csv_valid=filename_csv_valid,
                   model_name= model_name, model1=model1,
                   ...
                   epoch_finetuning=epoch_finetuning,
    ...
    if model_name == 'InceptionResnetV2':
        if PRE_TRAIN_TYPE == 'ImageNet':
            model1 = keras.applications.inception_v3.InceptionV3(input_shape=None, include_top=True, weights='imagenet',
                                                                classes=1000)
        if PRE_TRAIN_TYPE == 'Fundus':
            model1 = '/home/ubuntu/dlp/deploy_models_2019/bigclass_multiclass/Transfer_learning/InceptionResnetV2-006-0.962.hdf5'
    ...
    if model_name == 'InceptionV3':
        if PRE_TRAIN_TYPE == 'ImageNet':
            model1 = keras.applications.inception_v3.InceptionV3(input_shape=None, include_top=True, weights='imagenet',
                                                                classes=1000)
        if PRE_TRAIN_TYPE == 'Fundus':
            mode1 = '/home/ubuntu/dlp/deploy_models_2019/bigclass_multiclass/2019_4_19/split_pat_id/Inception_V3-006-0.955.hdf5'

        train_task(filename_csv_train=filename_csv_train, filename_csv_valid=filename_csv_valid,
                   model_name=model_name, model1=mode1,
                   num_classes=NUM_CLASSES, image_size=IMAGE_SIZE,
                   add_top=False, change_top=True, freeze_layes_num=None,
                   inter_class_ratio=inter_class_ratio, positive_weight_ratio=positive_weight_ratio,
                   exclusion_loss_ratio = exclusion_loss_ratio, smooth_factor=smooth_factor,
