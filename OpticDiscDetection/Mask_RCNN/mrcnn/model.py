...
class PyramidROIAlign(KE.Layer):
    ...
    - image_meta: [batch, (meta data1)] Image details. See compose_image_meta()
...
def rpn_bbox_loss_graph(config, target_bbox, rpn_match, rpn_bbox):
    ...
    helper: the model helper object.
...
def load_image_gt(dataset, config, image_id, augment=False, augmentation=None,
                  use_mini_mask=False):
    """Load and return ground truth data1 for an image (image, mask, bounding boxes).
...
def data_generator(dataset, config, shuffle=True, augment=False, augmentation=None,
    ...
    dataset: The Dataset object to pick data1 from
    helper: The model helper object
...
class MaskRCNN():
    ...
    def __init__(self, mode, config, model_dir=''):
        ...
        helper: A Sub-class of the Config class
    ...
    def build(self, mode, config):
        ...
        # Top-down Layers
        # TODO: add assert to varify feature map sizes match what's in helper
        ...
        if config.GPU_COUNT > 1:
            from OpticDiscDetection.Mask_RCNN.mrcnn import ParallelModel
    ...
    def mold_inputs(self, images):
        ...
        image_metas: [N, length of meta data1]. Details about each image.
    ...
    def detect_molded(self, molded_images, image_metas, verbose=0):
        ...
        image_metas: image meta data1, also retruned by load_image_gt()
