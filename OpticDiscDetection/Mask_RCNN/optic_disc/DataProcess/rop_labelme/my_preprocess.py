...
convert_json_mask('/media/ubuntu/data1/公开数据集/OpticDiscDetection/ROP/original/images',
...
resize_images_dir_rop('/media/ubuntu/data1/公开数据集/OpticDiscDetection/ROP/original',
...
resize_images_dir(source_dir='/media/ubuntu/data1/公开数据集/OpticDiscDetection/ROP/preprocess',
